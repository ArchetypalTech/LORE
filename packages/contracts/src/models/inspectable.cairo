...
use lore::{
    models::{index::{Entity, Inspectable, Player}, components::Component},
    new_components::{
        entity_trait::EntityImpl, inspectable_trait::InspectableImpl, player_trait::PlayerImpl,
    },
    types::{
        command_type::{Command, Token}, component_type::{InspectableActions, ActionMapInspectable},
    },
