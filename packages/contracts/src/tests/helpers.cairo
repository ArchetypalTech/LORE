...
fn namespace_def() -> NamespaceDef {
    let ndef = NamespaceDef {
        namespace: "lore",
        resources: [
            TestResource::Model(m_Dict::TEST_CLASS_HASH.into()),
            TestResource::Model(m_Player::TEST_CLASS_HASH.into()),
            TestResource::Model(m_PlayerStory::TEST_CLASS_HASH.into()),
            TestResource::Model(m_StoryLine::TEST_CLASS_HASH.into()),
            TestResource::Model(m_Entity::TEST_CLASS_HASH.into()),
            TestResource::Model(m_Reactable::TEST_CLASS_HASH.into()),
            TestResource::Model(m_DescriptionText::TEST_CLASS_HASH.into()),
            TestResource::Model(m_Area::TEST_CLASS_HASH.into()),
            TestResource::Model(m_Exit::TEST_CLASS_HASH.into()),
            TestResource::Model(m_Container::TEST_CLASS_HASH.into()),
            TestResource::Model(m_InventoryItem::TEST_CLASS_HASH.into()),
            TestResource::Model(m_ParentToChildren::TEST_CLASS_HASH.into()),
            TestResource::Model(m_ChildToParent::TEST_CLASS_HASH.into()),
            TestResource::Model(m_Trigger::TEST_CLASS_HASH.into()),
            TestResource::Model(m_TriggerIndex::TEST_CLASS_HASH.into()),
            TestResource::Model(m_Condition::TEST_CLASS_HASH.into()),
            TestResource::Model(m_PropertyRegistry::TEST_CLASS_HASH.into()),
            TestResource::Model(m_Effect::TEST_CLASS_HASH.into()),
            TestResource::Model(m_Action::TEST_CLASS_HASH.into()),
            // TestResource::Event(),
