...
pub impl EffectImpl of EffectTrait {
    fn apply_effect(
        ...
        match self.component {
            Components::Area => {
                ...
                // THIS WOULD BE FOR THE COMPONENT VARIABLE TO UPDATE CHANGES ON THE COMPONENT WHEN
            // changed?
    ...
    fn update_property(
        ...
        let (_current_value_opt, access_opt) = VariablePropertyImp::get_property(
            @world, key, @property, component_type,
        );
