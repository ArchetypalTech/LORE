    ...
    fn output_error(self: Error, player: Player, ref world: WorldStorage, game_id: u128) {
        let texts = match self {
            ...
            Error::DirectionNotMatch => array![
                "No, wrong direction", "Can you even go there?", "You can't go there",
            ],
            Error::Unenterable => array![
                "You can't go there", "It's not open", "It's closed", "It's unenterable",
            ],
            ...
            Error::NoTargetEntity |
            Error::ActionFailed => array![
